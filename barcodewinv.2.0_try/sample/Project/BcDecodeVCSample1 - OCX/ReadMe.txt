========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : BcDecodeVCSample1
========================================================================


AppWizard が生成した BcDecodeVCSample1 には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには BcDecodeVCSample1 を構成している各ファイルの概要説明が含まれています。

BcDecodeVCSample1.dsp
...
BcDecodeVCSample1.h
    ...
    みます） をインクルードし、また CBcDecodeVCSample1App アプリケーションクラスを宣
    言します。

BcDecodeVCSample1.cpp
    このファイルは CBcDecodeVCSample1App アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。

BcDecodeVCSample1.rc
...
res\BcDecodeVCSample1.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル BcDecodeVCSample1.rc によってインクルード
    されます。

res\BcDecodeVCSample1.rc2
...
BcDecodeVCSample1Dlg.h, BcDecodeVCSample1Dlg.cpp - ダイアログ
    これらのファイルは CBcDecodeVCSample1Dlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な BcDecodeVCSample1.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) BcDecodeVCSample1.pch 
